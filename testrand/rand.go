...
// RandAlphaNumeric creates a random byte slice of given length composed of numbers and letters.
func RandAlphaNumeric(length int) []byte {
	return bytesOf(length, letters+numbers)
}

// RandNumeric creates a random byte slice of given length composed of numbers.
