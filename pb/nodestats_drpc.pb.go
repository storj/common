...
func (drpcEncoding_File_nodestats_proto) MarshalAppend(buf []byte, msg drpc.Message) ([]byte, error) {
...
func (x *drpcNodeStats_GetStatsStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcNodeStats_DailyStorageUsageStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcNodeStats_PricingModelStream) GetStream() drpc.Stream {
	return x.Stream
}
