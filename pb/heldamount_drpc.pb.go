...
func (drpcEncoding_File_heldamount_proto) MarshalAppend(buf []byte, msg drpc.Message) ([]byte, error) {
...
func (x *drpcHeldAmount_GetPayStubStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcHeldAmount_GetAllPaystubsStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcHeldAmount_GetPaymentStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcHeldAmount_GetAllPaymentsStream) GetStream() drpc.Stream {
	return x.Stream
}
