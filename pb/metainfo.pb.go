...
type Range_StartLimit struct {
	StartLimit *RangeStartLimit `protobuf:"bytes,1,opt,name=start_limit,json=startLimit,proto3,oneof"`
}
type Range_Start struct {
	Start *RangeStart `protobuf:"bytes,2,opt,name=start,proto3,oneof"`
}
type Range_Suffix struct {
	Suffix *RangeSuffix `protobuf:"bytes,3,opt,name=suffix,proto3,oneof"`
}
...
func (*Range) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Range_OneofMarshaler, _Range_OneofUnmarshaler, _Range_OneofSizer, []interface{}{
...
func _Range_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*Range)
	// Range
	switch x := m.Range.(type) {
	case *Range_StartLimit:
		_ = b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.StartLimit); err != nil {
			return err
		}
	case *Range_Start:
	...
	case *Range_Suffix:
		...
		if err := b.EncodeMessage(x.Suffix); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("Range.Range has unexpected type %T", x)
	}
	return nil
}

func _Range_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Range)
	switch tag {
	case 1: // Range.start_limit
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RangeStartLimit)
		err := b.DecodeMessage(msg)
		m.Range = &Range_StartLimit{msg}
		return true, err
	case 2: // Range.start
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
...
func _Range_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*Range)
	// Range
	switch x := m.Range.(type) {
	case *Range_StartLimit:
		s := proto.Size(x.StartLimit)
		n += 1 // tag and wire
...
type BatchRequestItem_ObjectDownload struct {
	ObjectDownload *ObjectDownloadRequest `protobuf:"bytes,23,opt,name=object_download,json=objectDownload,proto3,oneof"`
}
...
func _BatchRequestItem_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *BatchRequestItem_ObjectDownload:
		_ = b.EncodeVarint(23<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ObjectDownload); err != nil {
			return err
		}
...
func _BatchRequestItem_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 22: // Request.pending_streams
		...
		return true, err
	case 23: // Request.object_download
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ObjectDownloadRequest)
		err := b.DecodeMessage(msg)
		m.Request = &BatchRequestItem_ObjectDownload{msg}
		return true, err
...
type BatchResponseItem_ObjectDownload struct {
	ObjectDownload *ObjectDownloadResponse `protobuf:"bytes,23,opt,name=object_download,json=objectDownload,proto3,oneof"`
}
...
func _BatchResponseItem_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *BatchResponseItem_ObjectDownload:
		_ = b.EncodeVarint(23<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ObjectDownload); err != nil {
			return err
		}
...
func _BatchResponseItem_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 22: // Response.pending_streams
		...
		return true, err
	case 23: // Response.object_download
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ObjectDownloadResponse)
		err := b.DecodeMessage(msg)
		m.Response = &BatchResponseItem_ObjectDownload{msg}
		return true, err
...
var fileDescriptor_631e2f30a93cd64e = []byte{
	...
	,
}
