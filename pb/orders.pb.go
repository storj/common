...
type SettlementWithWindowResponse struct {
	...
	ActionAmount         map[int32]int64                     `protobuf:"bytes,2,rep,name=action_amount,json=actionAmount,proto3" json:"action_amount,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                            `json:"-"`
	XXX_unrecognized     []byte                              `json:"-"`
	XXX_sizecache        int32                               `json:"-"`
}
...
func (m *SettlementWithWindowResponse) GetActionAmount() map[int32]int64 {
	if m != nil {
		return m.ActionAmount
	}
	return nil
}
...
func init() {
	...
	proto.RegisterMapType((map[int32]int64)(nil), "orders.SettlementWithWindowResponse.ActionAmountEntry")
}
...
var fileDescriptor_e0f5d4cf0fc9e41b = []byte{
	...
	,
}
