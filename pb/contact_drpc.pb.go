...
func (drpcEncoding_File_contact_proto) MarshalAppend(buf []byte, msg drpc.Message) ([]byte, error) {
...
func (x *drpcContact_PingNodeStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcNode_CheckInStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcNode_PingMeStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcNode_GetTimeStream) GetStream() drpc.Stream {
	return x.Stream
}
