...
type DRPCMetainfoClient interface {
	...
	ExchangeSegmentPieceOrders(ctx context.Context, in *SegmentExchangePieceOrdersRequest) (*SegmentExchangePieceOrdersResponse, error)
...
func (c *drpcMetainfoClient) ExchangeSegmentPieceOrders(ctx context.Context, in *SegmentExchangePieceOrdersRequest) (*SegmentExchangePieceOrdersResponse, error) {
	out := new(SegmentExchangePieceOrdersResponse)
	err := c.cc.Invoke(ctx, "/metainfo.Metainfo/ExchangeSegmentPieceOrders", drpcEncoding_File_metainfo_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DRPCMetainfoServer interface {
	...
	ExchangeSegmentPieceOrders(context.Context, *SegmentExchangePieceOrdersRequest) (*SegmentExchangePieceOrdersResponse, error)
...
func (s *DRPCMetainfoUnimplementedServer) ExchangeSegmentPieceOrders(context.Context, *SegmentExchangePieceOrdersRequest) (*SegmentExchangePieceOrdersResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (DRPCMetainfoDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	...
	case 15:
		return "/metainfo.Metainfo/ExchangeSegmentPieceOrders", drpcEncoding_File_metainfo_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCMetainfoServer).
					ExchangeSegmentPieceOrders(
						ctx,
						in1.(*SegmentExchangePieceOrdersRequest),
					)
			}, DRPCMetainfoServer.ExchangeSegmentPieceOrders, true
	case 16:
...
type DRPCMetainfo_ExchangeSegmentPieceOrdersStream interface {
	drpc.Stream
	SendAndClose(*SegmentExchangePieceOrdersResponse) error
}

type drpcMetainfo_ExchangeSegmentPieceOrdersStream struct {
	drpc.Stream
}

func (x *drpcMetainfo_ExchangeSegmentPieceOrdersStream) SendAndClose(m *SegmentExchangePieceOrdersResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_metainfo_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
