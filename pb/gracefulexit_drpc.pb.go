...
func (drpcEncoding_File_gracefulexit_proto) MarshalAppend(buf []byte, msg drpc.Message) ([]byte, error) {
...
func (x *drpcSatelliteGracefulExit_ProcessStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcSatelliteGracefulExit_GracefulExitFeasibilityStream) GetStream() drpc.Stream {
	return x.Stream
}
