...
func (drpcEncoding_File_piecestore2_proto) MarshalAppend(buf []byte, msg drpc.Message) ([]byte, error) {
...
func (x *drpcPiecestore_UploadStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcPiecestore_DownloadStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcPiecestore_DeleteStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcPiecestore_DeletePiecesStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcPiecestore_RetainStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcPiecestore_RetainBigStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcPiecestore_RestoreTrashStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcPiecestore_ExistsStream) GetStream() drpc.Stream {
	return x.Stream
}
