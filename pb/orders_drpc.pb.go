...
func (drpcEncoding_File_orders_proto) MarshalAppend(buf []byte, msg drpc.Message) ([]byte, error) {
...
func (x *drpcOrders_SettlementWithWindowStream) GetStream() drpc.Stream {
	return x.Stream
}
